...
import com.example.android.asteroidradar.AsteroidFetchFilter
...
class MainFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        viewModel.updateFilter(
            when (item.itemId) {
                R.id.show_week_menu -> AsteroidFetchFilter.SHOW_WEEK
                R.id.show_today_menu -> AsteroidFetchFilter.SHOW_TODAY
                else -> AsteroidFetchFilter.SHOW_ALL
            }
        )
        return true
    }
